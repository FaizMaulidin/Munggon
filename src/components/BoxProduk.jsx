...
const BoxProduk = ({data}) => {
  ...
  if (data){
    return (
      <Link to={'/produk?id='+data.id} state={lang} className="box cursor-pointer transition-all duration-500 hover:scale-[1.015] saturate-0 hover:saturate-50 rounded-md bg-cover h-full w-[26rem] text-2xl tracking-[0.2em] font-extralight text-white p-5 flex items-end overflow-hidden max-[480px]:w-32 max-[480px]:text-lg max-[480px]:p-2 max-[480px]:tracking-wide">
