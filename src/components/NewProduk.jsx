...
// toppest 580, botfirst-top 800, botfirst-bot 1040, bottest 1880
    ...
    return (
        <div className='w-full h-[120vh] bg-darkerblue p-4 flex flex-col relative justify-center items-center text-white overflow-hidden max-[375px]:h-[90vh]'>
            <h1 className=' text-[5rem] absolute font-semibold rotate-12 top-[5.75rem] right-8 skew-x-6 max-[375px]:text-4xl max-[375px]:top-16 max-[375px]:right-4'>Produk Unggulan</h1>
            <div className='w-full h-full overflow-hidden'>
                <div ref={slide} className='w-[100%] h-[40%] flex justify-center rotate-12 skew-x-6 gap-8 p-4 max-[375px]:w-fit max-[375px]:gap-2 '>
                    <BoxProduk data={data[1]}/>
                    <BoxProduk data={data[0]}/>
                    <BoxProduk data={data[2]}/>
                </div>
                <div ref={slide2} className='w-[100%] h-[40%] justify-center flex rotate-12 skew-x-6 gap-8 p-4 max-[375px]:w-fit max-[375px]:gap-2'>
