...
const KegWrapper = ({refs, res}) => {
    ...
    return (
        <div ref={refs} className="flex gap-6 items-center h-fit transition-all duration-100 opacity-20 scroll-ml-4">
            <div className=' bg-lightgray2 font-light rounded-2xl w-[20rem] h-[17rem] self-start flex shadow-kegwrap flex-col p-6 gap-8 max-[480px]:w-[16rem] max-[480px]:h-[14rem] max-[480px]:gap-4 '>
