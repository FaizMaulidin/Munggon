...
const KegWrapper = ({refs, res}) => {
    ...
    return (
        <div ref={refs} className="flex gap-6 items-center h-fit transition-all duration-100 opacity-20 scroll-ml-4 max-[480px]:flex-col">
            <div className=' bg-lightgray2 font-light rounded-2xl w-[20rem] h-[17rem] self-start flex shadow-kegwrap flex-col p-6 gap-8 max-[480px]:w-[16rem] max-[480px]:h-[14rem] max-[480px]:gap-4 max-[480px]:translate-x-12'>
            ...
            <div className=' flex justify-center items-center gap-6 max-[480px]:items-start'>
                <div  className=' bg-neutral-700 rounded-2xl w-[17rem] h-[23rem] shadow-kegwrap bg-cover bg-center overflow-hidden relative max-[480px]:w-[12rem] max-[480px]:h-[15rem]'> 
                ...
                <div className=' bg-neutral-700 rounded-2xl w-[22rem] h-[21rem] shadow-kegwrap bg-cover bg-center overflow-hidden relative max-[480px]:w-[17rem] max-[480px]:h-[13rem]'>
