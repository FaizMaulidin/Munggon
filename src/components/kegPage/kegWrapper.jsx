    ...
    return (
        <div ref={refs} className="flex gap-6 items-center h-fit transition-all duration-100 opacity-30 scroll-ml-4 max-[480px]:flex-col max-[480px]:snap-start">
            ...
            <div className=' flex justify-center w-[80%] h-[23rem] items-center gap-6 max-[480px]:items-start max-[480px]:w-full max-[480px]:h-[12rem] max-[960px]:flex-col max-[480px]:flex-row'>
                <div  className=' bg-neutral-700 rounded-2xl w-[17rem] h-full shadow-kegwrap bg-cover bg-center overflow-hidden relative max-[1080px]:w-[12rem] max-[1240px]:w-[14.5rem]'> 
                ...
                <div className=' bg-neutral-700 rounded-2xl w-[22rem] h-[90%] shadow-kegwrap bg-cover bg-center overflow-hidden relative max-[1080px]:w-[17rem] max-[1240px]:w-[20rem]'>
