...
const Navbar = ({theme, handleClick}) => {
    ...
    return (
        <div style={{
            ...
            <ul className=' flex gap-2 max-[375px]:hidden'>
            ...
            <button onClick={() => setMenu(true)} className=' hidden text-2xl max-[375px]:flex'>
                <FontAwesomeIcon icon={faBars}/>
            </button>
            {menu 
                ? <div className='fixed right-0 top-0 w-screen h-screen bg-neutral-900 bg-opacity-50 max-[375px]:flex hidden justify-end'>
